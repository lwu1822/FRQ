...
public class Person {
    ...
    @NonNull
    @Size(min = 2, max = 30, message = "Name (2 to 35 chars)")
    private String name;
    ...
    public Person(String email, String password, String name, Date dob, Double height, String role) {
        this.email = email;
    ...
    public int getAge() {
        if (this.dob != null) {
            // IMPORTANT: convert dob to current zone, then remove all the junk, leave
            // behind
            // YYYY-MM-DD
     ...
     * //return ("Person(id=" + this.id + ", email=" + this.email + ", password=" +
     * this.password + ", name=" + this.name + ", dob=" + this.dob + ", stats=" +
     * this.stats + ", thirdMap=" + this.thirdMap + ")" );
     * }
     */
    ...
    public String toString() {
        return ("Person(id=" + this.id + ", email=" + this.email + ", password=" + this.password + ", name=" + this.name
                + ", dob=" + this.dob + ", stats=" + this.stats + ", statsTwo=" + this.statsTwo + ", workout="
                + this.workout + ")");
    }

    public static void main(String[] args) {

        // IMPORTANT: If only do Date dob;, will h error: the local variable (var) may
        ...
        Person person = new Person("tedison@gmail.com", "123qwerty!", "Thomas Edison", dob, (Double) 70.0, "admin");
